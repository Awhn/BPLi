...
<a
	...
	class="fixed bottom-16 left-1/2 z-40 flex w-[calc(100%-1rem)] max-w-[calc(28rem-1rem)] -translate-x-1/2 items-center gap-3 overflow-hidden rounded-xl bg-surface-raised/95 px-3 py-2 shadow-lg backdrop-blur"
>
